...
sinhala_translit = XlitEngine(lang2use=["si"], beam_width=4, rescore=False, src_script_type = "en")
tamil_translit = XlitEngine(lang2use=["ta"], beam_width=10, rescore=False, src_script_type = "en")
